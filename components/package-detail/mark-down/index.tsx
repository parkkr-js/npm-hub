...
export default function Markdown({ packageName }: MarkDownProps) {
  ...
  return (
    <Card className="p-6">
      <main className="max-w-[1600px] mx-auto mt-4 flex flex-wrap justify-center items-start gap-1 transition-all duration-300">
        <article className="w-3/4">
          <div className="w-full max-h-[850px] overflow-y-auto bg-[#1e1e1e] text-white rounded-lg shadow-lg p-4">
            <ReactMarkdown
